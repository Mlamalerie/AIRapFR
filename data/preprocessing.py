...
def preprocess_genius_text(text, lower_case=True, lemmatization=False, stop_words_removal=False, punct_removal=False,token_output=False):
    ...
    return tokens if token_output else " ".join(tokens)
